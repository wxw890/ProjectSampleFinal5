...
private BoardService boardService;
	...
	@RequestMapping("/reply.board1")
	public ModelAndView ReplyPageMove(@RequestParam int b_seq){
		ModelAndView mav = new ModelAndView("/freeboard/Reply");
	...
	@RequestMapping(value="/reply.board1", method=RequestMethod.POST)
